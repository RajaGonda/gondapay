...
class CitrusGateway implements PaymentGatewayInterface {
    ...
    {
        $this->vanityUrl = Config::get('gondapay.citrus.vanityUrl');
        $this->secretKey = Config::get('gondapay.citrus.secretKey');
        ...
        $this->parameters['returnUrl'] = url(Config::get('gondapay.citrus.returnUrl'));
        $this->parameters['notifyUrl'] = url(Config::get('gondapay.citrus.notifyUrl'));
    }
    ...
    public function send()
    {
        ...
        return View::make('gondapay::citrus')->with('hash',$this->hash)

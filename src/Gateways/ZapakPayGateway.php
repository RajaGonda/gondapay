...
class ZapakPayGateway implements PaymentGatewayInterface {
    ...
    {
        $this->secret = Config::get('gondapay.zapakpay.secret');
        $this->merchantIdentifier = Config::get('gondapay.zapakpay.merchantIdentifier');
        $this->testMode = Config::get('gondapay.testMode');
        $this->parameters['merchantIdentifier'] = $this->merchantIdentifier;
        $this->parameters['returnUrl'] = url(Config::get('gondapay.zapakpay.returnUrl'));
    ...
    public function send()
    {
        ...
        return View::make('gondapay::zapakpay')->with('params',$this->parameters)

...
class PayUMoneyGateway implements PaymentGatewayInterface {
    ...
    {
        $this->merchantKey = Config::get('gondapay.payumoney.merchantKey');
        $this->salt = Config::get('gondapay.payumoney.salt');
        ...
        $this->parameters['surl'] = url(Config::get('gondapay.payumoney.successUrl'));
        $this->parameters['furl'] = url(Config::get('gondapay.payumoney.failureUrl'));
    ...
    public function send()
    {
        ...
        return View::make('gondapay::payumoney')->with('hash',$this->hash)

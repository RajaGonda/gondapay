...
class EBSGateway implements PaymentGatewayInterface {
    ...
    {
        $this->secretKey = Config::get('gondapay.ebs.secretKey');
        $this->testMode = Config::get('gondapay.testMode');

        $this->parameters['channel'] = 0;       // Standard
        $this->parameters['account_id'] = Config::get('gondapay.ebs.account_id');
        ...
        $this->parameters['return_url'] = url(Config::get('gondapay.ebs.return_url'));
    ...
    public function send()
    {
        ...
        return View::make('gondapay::ebs')->with('hash',$this->hash)

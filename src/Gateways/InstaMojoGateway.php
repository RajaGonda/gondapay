...
class InstaMojoGateway implements PaymentGatewayInterface {
    ...
    function __construct()
    {
        ...
        $this->api_key = Config::get('gondapay.instamojo.api_key');
        $this->auth_token = Config::get('gondapay.instamojo.auth_token');

        $this->parameters['redirect_url'] = url(Config::get('gondapay.instamojo.redirectUrl'));
    }
    ...
    public function send()
    {
        ...
        return View::make('gondapay::instamojo')->with('longurl',$this->response->payment_request->longurl);
